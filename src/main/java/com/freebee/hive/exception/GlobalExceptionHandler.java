...
public class GlobalExceptionHandler {
    @ExceptionHandler(value = {ComplianceException.class})
    public ResponseEntity<Error> handle(ComplianceException exception) {
    ...
    private void printStackTrace(Exception ex) {
        ...
        Arrays.stream(trace).filter(f -> f.getClassName().contains("com.freebee.hive"))
